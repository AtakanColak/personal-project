...
public class Tools {
	...
	// Assumes elem is initialized without an id
//	public static <E extends Identifier> Integer Identify(List<E> list, E elem) {
//		Integer index = IndexByNameEquals(list, elem.story_id, elem.name);
//		if (index == null) {
//			elem.id = list.size();
//			index = elem.id;
//			list.add(elem);
